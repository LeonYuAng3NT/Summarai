# -*- coding: utf-8 -*-
"""viedo2keyframes.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vnCd0GX_ADFjxGjkZLv9HdjQDspSeSkJ
"""
...
def keyframes_time(videopath, dir):
    ...
    for keyframe in frames[:NUM_TOP_FRAMES]:
        ...
        seconds.append(keyframe.id * 1/fps)
    ...
    while(success):
        if idx in keyframe_id_set:
            ...
            res.append({"img":dir + name})
            keyframe_id_set.remove(idx)
        idx = idx + 1
        success, frame = cap.read()
    cap.release()
    return res, sorted(seconds)
